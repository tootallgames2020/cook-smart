    ...
    <footer className="bg-gray-900 text-gray-300" role="contentinfo">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Community */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Join Our Community</h3>
            <p className="text-sm mb-4">
              Connect with fellow food lovers, share recipes, get cooking tips, and help shape Cook Smart's future.
            </p>
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <p className="text-xs text-gray-400 text-center">
                🎉 100+ beta testers • Recipe sharing • Direct feedback to developers
              </p>
            </div>
          </div>
        </div>
